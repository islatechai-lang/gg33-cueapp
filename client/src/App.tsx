    ...
    <WhopProvider experienceId={experienceId}>
      <div className="min-h-screen bg-background" data-experience-id={experienceId}>
        <Switch>
          ...
          <Route path="/experiences/:experienceId/birth-chart" component={BirthChartPage} />
    ...
    <WhopProvider companyId={companyId}>
      <div className="min-h-screen bg-background" data-company-id={companyId}>
        <Switch>
          ...
          <Route path="/dashboard/:companyId/birth-chart" component={BirthChartPage} />
          <Route component={Home} />
        </Switch>
      </div>
    </WhopProvider>
  ...
  return (
    <WhopProvider>
      <Switch>
        ...
        <Route path="/birth-chart" component={BirthChartPage} />
