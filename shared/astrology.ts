// shared/astrology.ts
// Shared astrology calculation engine using astronomical algorithms
...
export function getSignDetails(longitude: number): { sign: string; signIndex: number; degree: number; minute: number } {
...
export function calculateBirthChart(birthDate: Date, birthTime: string = '12:00', birthLocation: string = ''): BirthChartData {
